...
# maddpg
exp2m: 
	parallel -j 12 --colsep , --delay 10 --joblog=models/exp2m.parallel.log --header : python run_maddpg.py '"simple_adversary_v2" "exp2m_lr{lr}" --buffer_length=2500 --device="cpu" --seed={seed} --lr={lr}' ::: seed 40 103 59 ::: lr 0.01 
...
# maddpg
exp3m: 
	parallel -j 12 --colsep , --delay 10 --joblog=models/exp3m.parallel.log --header : python run_maddpg.py '"simple_crypto_v2" "exp3m_lr{lr}" --buffer_length=2500 --device="cpu" --seed={seed} --lr={lr}' ::: seed 40 103 59 ::: lr 0.01 
...
# maddpg
exp4m: 
	parallel -j 12 --colsep , --delay 10 --joblog=models/exp4m.parallel.log --header : python run_maddpg.py '"simple_push_v2" "exp4m_lr{lr}" --buffer_length=2500 --device="cpu" --seed={seed} --lr={lr}' ::: seed 40 103 59 ::: lr 0.01 
...
# maddpg
exp5m: 
	parallel -j 12 --colsep , --delay 10 --joblog=models/exp5m.parallel.log --header : python run_maddpg.py '"simple_reference_v2" "exp5m_lr{lr}" --buffer_length=2500 --device="cpu" --seed={seed} --lr={lr}' ::: seed 40 103 59 ::: lr 0.01 
...
# maddpg
exp6m: 
	parallel -j 12 --colsep , --delay 10 --joblog=models/exp6m.parallel.log --header : python run_maddpg.py '"simple_speaker_listener_v3" "exp6m_lr{lr}" --buffer_length=2500 --device="cpu" --seed={seed} --lr={lr}' ::: seed 40 103 59 ::: lr 0.01 
...
# maddpg
exp7m: 
	parallel -j 12 --colsep , --delay 10 --joblog=models/exp7m.parallel.log --header : python run_maddpg.py '"simple_spread_v2" "exp7m_lr{lr}" --buffer_length=2500 --device="cpu" --seed={seed} --lr={lr}' ::: seed 40 103 59 ::: lr 0.01 
...
# maddpg
exp8m: 
	parallel -j 12 --colsep , --delay 10 --joblog=models/exp8m.parallel.log --header : python run_maddpg.py '"simple_tag_v2" "exp8m_lr{lr}" --buffer_length=2500 --device="cpu" --seed={seed} --lr={lr}' ::: seed 40 103 59 ::: lr 0.01 
...
# maddpg
exp9m: 
	parallel -j 12 --colsep , --delay 10 --joblog=models/exp9m.parallel.log --header : python run_maddpg.py '"simple_world_comm_v2" "exp9m_lr{lr}" --buffer_length=2500 --device="cpu" --seed={seed} --lr={lr}' ::: seed 40 103 59 ::: lr 0.01 
